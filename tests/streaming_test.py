...
##########################################################################
    # CHART_EQUITY LOWERCASE/MIXED CASE SYMBOLS

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_equity_subs_and_add_success_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_equity_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_equity_add_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_equity_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # CHART_FUTURES lowercase/mixed-case symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_futures_subs_and_add_success_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_futures_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_futures_add_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_chart_futures_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # QUOTE FOR lowercase/mixedcase symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_equity_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_equity_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_equity_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_equity_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_quote_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # OPTION for lowercase/mixedcase symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_option_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_option_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_option_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_option_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_option_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # LEVELONE_FUTURES with lower/mixedcase symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # LEVELONE_FOREX with lower/mixedcase symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_forex_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_forex_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_forex_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_forex_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_forex_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # LEVELONE_FUTURES_OPTIONS with lower/mixedcase symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_options_subs_success_all_fields_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_options_subs_success_some_fields_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_options_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_options_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    # TODO: Replace this with real messages
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_level_one_futures_options_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # TIMESALE_EQUITY lower/mixed-case symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_equity_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_equity_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_equity_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_equity_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_equity_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # TIMESALE_FUTURES _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_futures_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_futures_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_futures_subs_success_some_fields_no_symbol_lowercase_symbols(
            self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_futures_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_futures_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # TIMESALE_OPTIONS _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_options_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_options_subs_success_some_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_options_subs_success_some_fields_no_symbol_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_options_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    # TODO: Replace this with real messages
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_timesale_options_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # LISTED_BOOK _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_listed_book_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_listed_book_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # NASDAQ_BOOK _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_nasdaq_book_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_nasdaq_book_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # OPTIONS_BOOK _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_options_book_subs_success_all_fields_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_options_book_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # Common book handler functionality _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_listed_book_handler_lowercase_symbols(self, ws_connect):
        async def subs():
            await self.client.listed_book_subs(['GooG', 'msft'])
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_nasdaq_book_handler_lowercase_symbols(self, ws_connect):
        async def subs():
            await self.client.nasdaq_book_subs(['goog', 'mSFT'])
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_options_book_handler_lowercase_symbols(self, ws_connect):
        async def subs():
            await self.client.options_book_subs(['goOG', 'msFT'])
    ...
    @no_duplicates
    async def __test_book_handler_lowercase_symbols(
            self, ws_connect, service, subs, register_handler):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    ##########################################################################
    # NEWS_HEADLINE _lowercase_symbols

    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_news_headline_subs_success_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_news_headline_subs_failure_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    # TODO: Replace this with real messages.
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_news_headline_handler_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
    ...
    @no_duplicates
    @asynctest.patch('tda.streaming.ws_client.connect', new_callable=asynctest.CoroutineMock)
    async def test_news_headline_not_authorized_notification_lowercase_symbols(self, ws_connect):
        socket = await self.login_and_get_socket(ws_connect)
