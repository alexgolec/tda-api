...
class ConstructRepeatOrderTest(unittest.TestCase):
    ...
    def test_market_equity_order_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "MARKET",
    ...
    def test_missing_orderStrategyType_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "MARKET",
    ...
    def test_unknown_orderLegType_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "MARKET",
    ...
    def test_unknown_orderLegType_codegen_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "MARKET",
    ...
    def test_limit_options_order_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "LIMIT",
    ...
    def test_complex_options_order_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "NET_DEBIT",
    ...
    def test_one_triggers_other_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "GOOD_TILL_CANCEL",
            "orderType": "LIMIT",
    ...
    def test_oco_inside_oto_lowercase_tests(self):
        historical_order = json.loads('''{
            "session": "NORMAL",
            "duration": "DAY",
            "orderType": "LIMIT",
